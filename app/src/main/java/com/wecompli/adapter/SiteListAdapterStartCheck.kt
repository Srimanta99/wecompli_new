...
class SiteListAdapterStartCheck(val activity: MainActivity, val siteList:ArrayList<SiteListResponseModel.SiteDetails>, val siteListFragment: StartCheckFragment)
    : RecyclerView.Adapter<SiteListAdapterStartCheck.ViewHolder>(){
