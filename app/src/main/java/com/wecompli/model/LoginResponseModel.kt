...
val payment_start_datetime:String,val payment_end_datetime:String,val payment_status:String,val created_at:String,val token:String,val process:Boolean,val message:String) {
}