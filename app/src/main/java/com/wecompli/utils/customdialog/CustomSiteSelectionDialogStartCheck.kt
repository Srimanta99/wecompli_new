...
class CustomSiteSelectionDialogStartCheck(
    val mainActivity: MainActivity,
    val siteList: ArrayList<SiteListResponseModel.SiteDetails>,
    val startCheckFragment: StartCheckFragment
):Dialog(mainActivity) {
    var siteSelectionListAdapte:SiteSelectionListAdapterStartCheck?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_ok.setOnClickListener {
            startCheckFragment.setselection();
            dismiss()
        }
        cancel.setOnClickListener {
            dismiss()
        }
        siteSelectionListAdapte= SiteSelectionListAdapterStartCheck(mainActivity,siteList,startCheckFragment,this)
