...
class CustomQRCodeSelectionChecksAdd(val mainActivity: MainActivity, val addchecks: AddChecksFragment): Dialog(mainActivity) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        llactive.setOnClickListener {
            dismiss()
            addchecks.QrcodeShow()
        }
        ll_inactive.setOnClickListener {
            dismiss()
            addchecks.QrcodeHide()
        }
