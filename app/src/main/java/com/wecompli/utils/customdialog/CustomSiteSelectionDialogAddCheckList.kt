...
import com.wecompli.adapter.SiteSelectionListAdapterAddChecklist
...
class CustomSiteSelectionDialogAddCheckList(
    val mainActivity: MainActivity,
    val siteList: ArrayList<SiteListResponseModel.SiteDetails>,
    val addchecks: AddCheckFragment):Dialog(mainActivity) {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_ok.setOnClickListener {
            addchecks.setselection()
            dismiss()
        }
        cancel.setOnClickListener {
            dismiss()
        }
        var siteSelectionListAdapter=SiteSelectionListAdapterAddChecklist(mainActivity,siteList,addchecks)
