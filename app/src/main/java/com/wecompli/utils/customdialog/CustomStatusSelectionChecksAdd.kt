...
class CustomStatusSelectionChecksAdd(val mainActivity: MainActivity, val addchecks: AddChecksFragment): Dialog(mainActivity) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        llactive.setOnClickListener {
            dismiss()
            addchecks.changeActiveStatus()
        }
        ll_inactive.setOnClickListener {
            dismiss()
            addchecks.changeInActiveStatus()
        }
