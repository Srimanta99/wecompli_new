...
class CustomSiteSelectionDialogFautList(
    val mainActivity: MainActivity,
    val siteList: ArrayList<SiteListResponseModel.SiteDetails>,

    val UserEditFragment: FaultListFragment):Dialog(mainActivity) {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var siteSelectionListAdapter=SiteSelectionListAdapterFaultList(mainActivity,siteList,UserEditFragment)
